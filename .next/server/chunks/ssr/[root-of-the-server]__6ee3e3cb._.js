...
function RegisterPage() {
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post("/api/register", form);
            if (res.data.success) {
                // Automatically sign in the new user
                const signInRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["signIn"])("credentials", {
                    redirect: false,
                    email: form.email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6ee3e3cb._.js.map